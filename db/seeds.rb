...
Choice.create(description: "DO IT", parent_bot_response_id: 5, next_bot_response_id: 7)
Choice.create(description: "I CAN'T", parent_bot_response_id: 5, next_bot_response_id: 8)
